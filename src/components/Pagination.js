  ...
  return (
    <div className="clearfix">
      ...
      <ul className="pagination">
        ...
        >
          <a className="page-link" href="#!" onClick={() => setCurrentButton( (prev) => prev ===1 ? prev : prev-1 )}>
            Previous
          </a>
        </li>
        ...
        <li
          className={`${
            currentButton === numOfPages.length ? "page-item disabled" : "page-item"
          }`}
        >
          <a className="page-link" href="#!" onClick={() => setCurrentButton( (next) => next === numOfPages.length ? next : next+1 )}>
            Next
          </a>
        </li>
      </ul>
